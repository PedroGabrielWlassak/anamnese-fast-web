...
FREQ_TITLES = {
    "IVAS / Amigdalite / Resfriado", "Faringoamigdalite", "Amigdalite Aguda",
    "Sinusite Aguda", "Otite Média Aguda", "Otite Externa",
    "Rinite Alérgica", "Alergia / Rinite Alérgica", "GECA / Gastroenterite (adulto)",
    "Cefaleia", "Enxaqueca", "Lombalgia / Mialgia", "Cólica Menstrual ou Sangramento",
    "Cistite / ITU", "Pielonefrite", "Dengue", "Conjuntivite",
    "Alergia", "Herpes Zoster", "Herpes Simples", "Escabiose", "Gota",
    "Vertigem / Labirintite / Tontura", "Epigastralgia / Pirose",
    "Doença do Refluxo Gastroesofágico", "Gastrite / DRGE", "Constipação",
    "Elevação Importante da PA (sem LOA)", "Influenza", "Pneumonia", "Bronquite",
    "Nefrolitíase / Cólica Nefrética", "Hemorroida", "Enjoo / Náuseas",
    "Cólica Biliar", "Disenteria", "Impetigo", "Abscesso Cutâneo",
    "Náuseas e vômitos (gestante)", "ITU / Cistite (gestante)",
}

# ---- Sinônimos / apelidos p/ busca (termo digitado -> palavras extras no índice) ----
ALIASES = {
    "IVAS / Amigdalite / Resfriado": "gripe resfriado ivas coriza espirro tosse dor de garganta",
    ...
    "Otite Média Aguda": "dor de ouvido otalgia ouvido otite oma",
    "Otite Externa": "dor de ouvido ouvido nadador otite",
    "Rinite Alérgica": "espirro coriza nariz alergia",
    "Alergia / Rinite Alérgica": "coceira prurido urticaria alergia rinite espirro coriza",
    "GECA / Gastroenterite (adulto)": "diarreia dor de barriga vomito nausea virose intestino gastroenterite",
    ...
    "Cistite / ITU": "itu infeccao urinaria disuria ardencia ao urinar cistite",
    "Pielonefrite": "itu alta infeccao urinaria rim febre lombar",
    "Nefrolitíase / Cólica Nefrética": "pedra no rim calculo renal colica renal nefrolitiase",
    ...
    "Vertigem / Labirintite / Tontura": "tontura labirintite vertigem vppb",
    ...
    "AVC Isquêmico (AVCI)": "avc derrame deficit isquemico",
    "AVC Hemorrágico (AVCH)": "avc derrame hemorragia",
    ...
    "Enjoo / Náuseas": "enjoo nausea vomito",
